    ...
    >
      <div className="mx-auto max-w-[1200px] flex items-center justify-between px-6 h-16">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-bg-secondary border border-border hover:border-border-hover px-3 py-1.5 text-xs font-mono text-text-secondary hover:text-text-primary transition-colors"
        >

    ...
    <SectionWrapper id="features">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
        {FEATURES.map((feature, i) => (
          <motion.div
            key={feature.title}
            className="group relative rounded-xl border border-border bg-bg-secondary/50 p-6 transition-all duration-200 hover:border-border-hover hover:-translate-y-0.5"
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl bg-accent/0 group-hover:bg-accent-glow transition-colors duration-300 pointer-events-none" />

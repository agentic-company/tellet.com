...
const lines = [
  ...
  { text: "", type: "blank" },
  { text: "  ? Describe your business:", type: "prompt" },
  { text: '  > We sell specialty coffee subscriptions to', type: "input" },
  { text: '    coffee enthusiasts aged 25-45...', type: "input" },
  { text: "", type: "blank" },
  { text: "  Generating your AI team...", type: "spinner" },
  { text: "", type: "blank" },
  { text: "  Your team:", type: "success" },
  { text: "  Barista  Customer Support", type: "agent" },
  { text: "  Roaster  Marketing", type: "agent" },
  { text: "  Grinder  Sales", type: "agent" },
  { text: "", type: "blank" },
  { text: "  Done! cd sunny-coffee && npm run dev", type: "success" },
] as const;
